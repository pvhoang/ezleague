...
return [
    ...
    'end_time_after_start_time'  => '結束時間必須晚於開始時間。',
    ...
    'latitude'             => ':attribute 必须是有效的纬度（介于 -90 和 90 之间）。',
    'longitude'            => ':attribute 必须是有效的经度（介于 -180 和 180 之间）。',
    ...
    'name_invalid'         => ':Attribute 不能包含数字或特殊字符。',
    'not_equal'            => ':Attribute 不能等于 :other。',
    ...
    'attributes'           => [
        ...
        'district'                 => '地区',
        'dob'                      => '出生日期',
        'document_expiry_date'     => '文件到期日期',
        'document_photo'           => '文件照片',
        'document_type'            => '文件类型',
        'duration'                 => '期间',
        'email'                    => '邮箱',
        'end_date'                 => '结束日期',
        'end register date'        => '结束注册日期',
        'end_time'                 => '结束时间',
        'excerpt'                  => '摘要',
        'fee'                      => '费用',
        'filter'                   => '过滤',
